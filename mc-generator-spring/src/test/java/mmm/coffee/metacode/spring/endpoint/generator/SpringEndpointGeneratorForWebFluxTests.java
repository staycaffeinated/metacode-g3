...
class SpringEndpointGeneratorForWebFluxTests {
    ...
    void shouldGenerateRulesForThese(String archetypeName) {
        ...
        assertThat(archetype).isNoneOf(Archetype.Undefined, Archetype.Text);
    ...
    private MetaPropertiesHandler<RestEndpointDescriptor> setUpMetaPropertiesHandler() {
        ...
        when(mockConfiguration.getString(MetaProperties.FRAMEWORK)).thenReturn(Framework.SPRING_WEBFLUX.frameworkName());
