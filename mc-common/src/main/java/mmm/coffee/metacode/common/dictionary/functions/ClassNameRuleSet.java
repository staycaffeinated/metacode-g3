...
public class ClassNameRuleSet {
    ...
    public String resolveClassName(String archetypeName, String resource) {
        // If an archetype isn't found in this ruleset, add a suffix to make it easy to identify that archetype
        String pkgExpression = ruleset.getOrDefault(archetypeName, archetypeName + UNDEFINED_SUFFIX);
