...
public class RouteConstantsConverter {
    ...
    public String basePath() {
        return "BASE_PATH_" + resourceNameUpperCase;
    }

    public String create() {
        return "CREATE_" + resourceNameUpperCase;
    }

    public String findOne() {
        return "FIND_ONE_" + resourceNameUpperCase;
    }
    ...
    public String stream() {
        return "STREAM_" + resourceNameUpperCase;
    }

    public String update() {
        return "UPDATE_" + resourceNameUpperCase;
    }

    public String delete() {
        return "DELETE_" + resourceNameUpperCase;
    }
