...
public class ${endpoint.entityName}Controller {
    ...
    public ResponseEntity<List<${endpoint.pojoName}>> update${endpoint.entityName}(@PathVariable @ResourceId String id, @RequestBody @Validated(OnUpdate.class) ${endpoint.pojoName} ${endpoint.entityVarName}) {
