    ...
    class FindByTextTests {
        ...
        */
        ...
        void shouldReturnRowsWhenRowsWithTextExists() {
            ...
            Page<${EntityResource.className()}> result = serviceUnderTest.findByText(Optional.of("text"), pageable);
        ...
        void shouldReturnEmptyListWhenNoDataFound() {
            ...
            Page<${EntityResource.className()}> result = serviceUnderTest.findByText(Optional.of("foo"), pageable);
